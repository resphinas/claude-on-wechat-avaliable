...
## 本项目为 claude 接口阉割迷你版，完整项目已pr给原项目，请移至 1.37版本   [https://github.com/zhayujie/chatgpt-on-wechat/releases](https://github.com/zhayujie/chatgpt-on-wechat/releases/tag/1.3.7)   本阉割项目不在更新，作为私人历史项目封存。
